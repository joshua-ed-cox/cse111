...
def main():
    ...
    computed = mass / molar_mass

    print(f"{molar_mass:.5f} grams/mole")

    print(f"{computed:.5f} moles")

    """Parameters: none"""
    """Return: nothing"""


"""     chemical_formula = make_periodic_table()[0]
    chemical_formula_one = chemical_formula[0]
    mass_one = chemical_formula[2]
    print(chemical_formula_one)
    print("")
    print(mass_one) """

# Calling the function and storing the returned
# list in a variable
"""     return_list = make_periodic_table()
